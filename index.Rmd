...
### Statistik-Vorlesung Sitzung 05 - Samuel Merk - PH Karlsruhe

---  
`r typed::typed(c("Hallo, 💚-lich Willkommen und ein gutes neues Jahr 2022!", "Heute lernen wir mit der Regression ein Universaltool kennen.", "Mit Regressionsmodellen kann man die vielen »kleinen« statistischen Verfahren (t-Tests, Wilcoxon-Test, ANOVA, MANOVA, ...) ersetzen", "So muss man z.B. nur ein Set an Voraussetzungen lernen"), typeSpeed = 80, backSpeed = 20, backDelay = 3000, loop = T, contentType = "html")` 
...
---
# Evaluation
> Bitte füllen Sie den Evaluationsbogen unter https://bit.ly/merk025 aus.
...
.pull-left[
```{r, echo = F, out.width="100%", message=FALSE, warning=FALSE, fig.width = 6, fig.height=5}
